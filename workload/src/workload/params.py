...
from workload.features import CONFIDENTIAL_MPT
...
# Gated (workload/features.py): only confidential_mpt.py's handlers call these,
# and that module is only imported when the gate is on, so the whole section —
# including the confidential_crypto import — lives inside the guard.
#
