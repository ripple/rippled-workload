...
def nftoken_mint_txn(account, taxon, client):
    ...
    log.info("Minting: %s", nftoken_mint_info)
    ...
    try:
        ...
        log.info("Signed NFTokenMint transaction: %s", signed_nftoken_mint_txn)
...
def nftoken_mint(account, taxnon, client):
    ...
    log.info("nftoken_mint_response: %s", nftoken_mint_response)
...
def account_nfts(account, client):
    ...
    log.info("account_nfts_response: %s", account_nfts_response)
